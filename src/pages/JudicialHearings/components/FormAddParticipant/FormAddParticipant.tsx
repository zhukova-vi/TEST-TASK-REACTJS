...
import { ucFirst } from 'utils/app_helper';
import { FormFieldEditable } from 'components';
import { COLUMNS_TABLE_PARTICIPANTS } from '../FormCreationHearing/FormCreationHearingConstant';
        ...
        <>
          <div className='d-flex align-items-center'>
            ...
            <i
              ...
              onClick={() => {
                const id = values?.participants.length + 1;
                setListRowForEdit(list => [...list, id.toString()]);
                push({
                  id: id.toString(),
                });
              }}
